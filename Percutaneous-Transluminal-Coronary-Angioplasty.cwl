...
steps:
  ...
  percutaneous-transluminal-coronary-angioplasty-insert---primary:
    run: percutaneous-transluminal-coronary-angioplasty-insert---primary.cwl
    out:
    - output
    in:
      inputModule:
  ...
  therapeutic-percutaneous-transluminal-coronary-angioplasty---primary:
    ...
    in:
      ...
      potentialCases:
        id: potentialCases
        source: percutaneous-transluminal-coronary-angioplasty-insert---primary/output
