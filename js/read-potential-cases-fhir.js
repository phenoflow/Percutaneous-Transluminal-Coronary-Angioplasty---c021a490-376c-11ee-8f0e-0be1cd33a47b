...
(async () => {
  ...
  await fs.writeFile("percutaneous-transluminal-coronary-angioplasty-potential-cases.csv", "patient-id,dob,codes,last-encounter\n");
  for(let patient in patients) {
    try {
      ...
      await fs.appendFile("percutaneous-transluminal-coronary-angioplasty-potential-cases.csv", row);
    } catch(error) {
      console.log(error);
    }
  }
